...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first piece, *Toccata avanti la Messa della Domenica* has the following files:
